...
const SCHREIBEN_B2_TOPICS = {
  ...
  "03": {
    ...
    "time": "30 min",
    "locked": false,
    "ad": "Partyservice Francke – Feiern ohne Küchenstress\n\nSie planen eine Feier? Ob Geburtstag, Hochzeit, Jubiläum oder geschäftliche Veranstaltung, wir bieten den passenden Service: Essen, Getränke, Geschirr, Personal, Tischdekoration.\n\nWir erledigen alles ganz nach Ihren Wünschen, zuverlässig und in professioneller Qualität.\n\nUnser Angebot:\nkaltes oder warmes Buffet · Salatbuffet · Spezialitäten aus der Region · Kuchen und Torten · Desserts · Auf- und Abbau des Buffets · Getränkeservice · Geschirrverleih · Servicepersonal für Ihre Feier · Raum- und Tischdekoration\n\nAuf Wunsch kochen wir auch rein vegetarisch. Für bis zu 150 Personen.\nWir machen Ihnen gerne ein individuelles Angebot.\n\nPartyservice Francke, Veilchengasse 17, 20146 Hamburg",
    "situation": "Sie hatten eine große Familienfeier. Dafür hatten Sie beim Partyservice Francke Essen bestellt. Es gab jedoch viele Probleme und Sie beschweren sich.",
    "points": [
      "Schreiben Sie, warum Sie unzufrieden sind.",
      "Erklären Sie, warum Sie sich für diesen Partyservice entschieden hatten.",
      "Erläutern Sie, warum die Feier für Sie besonders wichtig war.",
      "Berichten Sie, wie Ihre Gäste reagiert haben."
    ]
  },
  "04": {
    "title": "Autovermietung Neustadt - Metro",
    "type": "Beschwerde",
    "level": "B2",
    "time": "30 min",
    "locked": false,
