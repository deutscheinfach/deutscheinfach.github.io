...
const SCHREIBEN_B2_TOPICS = {
  ...
  "03": {
    ...
    "time": "30 min",
    "locked": false,
    "ad": "FEIERN SIE MIT UNS – Partyservice Köstlich!\n\n• Individuelle Buffets für jeden Anlass\n• Frische, regionale Zutaten\n• Pünktliche Lieferung direkt zu Ihnen\n• Auch vegetarische & vegane Optionen\n\nPartyservice Köstlich\nGartenweg 8, 60313 Frankfurt\nwww.partyservice-koestlich.de",
    "situation": "Sie haben für Ihre Familienfeier ein Buffet beim Partyservice Köstlich bestellt. Das Essen kam zu spät und mehrere bestellte Gerichte haben gefehlt. Schreiben Sie eine Beschwerde und gehen Sie dabei auf die genannten Punkte ein.",
    "points": [
      "Was genau hatten Sie bestellt und wann sollte es geliefert werden?",
      "Was ist bei der Lieferung schiefgelaufen?",
      "Welche Folgen hatte das für Ihre Feier?",
      "Welche Entschädigung erwarten Sie und in welcher Frist?"
    ]
  },
  "04": {
